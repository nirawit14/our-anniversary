const CONFIG = {
  mainQuestion: "วันนี้เป็นวันครบรอบของเราใช่มั้ยนะ",
  subQuestion: "ตอบว่าใช่สิรอรัยอะ",
  yesButton: "ใช่",
  noButton: "ไม่",
  noEscapeTexts: [
    "เอ้าา ให้คิดอีกที 😝",
    "ก็บอกว่าให้คิดอีกทีไงอ้วน ลองอีกครั้งสิ 😜",
    "อือๆ ถือว่าใช่แล้วกันนะ! 💕",
  ],
  confirmTitle: "Welcome to our 2nd month",
  confirmText: "วันนี้ถือว่าเป็นวันครบรอบ 2 เดือนของเราแล้วนะ",
  badgeText: "คนโปรดของเค้า",
  nextButton: "ต่อไป",
  repeatButton: "ทวนคำถาม",
  flowerTitle: "นี่คือของขวัญพิเศษที่เค้าตั้งใจทำให้เธอเลยนะ",
  takeBouquetButton: "รับของขวัญ",
  bouquetMessage: "นั้นนน! ตอนนี้เป็นของเธอแล้วว 💕",
  nextFlowerButton: "ถัดไป",
  collageTitle: "ความทรงจำของเรา 2 เดือนที่ผ่านมา",
  collageSubtitle:
    "กดดูรูปได้นะจ๊ะติ๋ม 💖",
  nextCollageButton: "อีกหนึ่งหน้าจ้า…",
  finalTitle: "Happy 2nd Mensiversary nakub K'tim 💞",
  finalMessage: `เห้ออเผลอแป๊บเดียวก็ครบ 2 เดือนแล้วนะ ขอบคุณที่เข้ามาในชีวิตเค้า ขอบคุณสำหรับทุกอย่างที่ผ่านมาเลยนะ อยู่ด้วยกันแล้วมีความสุขมากจริงๆ 2 เดือนอาจจะดูไม่นาน แต่สำหรับเค้ามันเป็นช่วงเวลาที่ดีมากๆเลยนะ ขอให้เรายังมีกันแบบนี้ไปเรื่อยๆนะ ชอบเธอมากขึ้นทุกวันเลยสุขสันต์วันครบรอบนะค้าบจากเด้กกก 🤍`,
  restartButton: "เริ่มใหม่",
  copyButton: "คัดลอกข้อความ",
  copySuccess: "คัดลอกข้อความทำมัยยย!!",
};
...
const elements = {
  ...
  backToPage4: document.getElementById("backToPage4"),
  nextToPage6: document.getElementById("nextToPage6"),
...
function initEventListeners() {
  ...
  if (elements.backToPage4)
    elements.backToPage4.addEventListener("click", () => navigateTo(4));
  if (elements.nextToPage6)
...
function openImageModal(src, alt) {
  ...
  elements.imageModalImg.alt = alt || "รูปภาพ";
  elements.imageModalCaption.textContent = alt || "คลิกเพื่อปิด";
